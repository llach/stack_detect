...
class StackGrasp3D(Node):
    ...
    def __init__(self, executor=None):
        ...
        self.poseusb = self.create_subscription(PoseStamped, '/approach_pose', self.pose_cb, 0, callback_group=self.mecbg)
    ...
    def plan_timer(self):
        ...
        print(self.current_q, approach_q)
        print(self.send_traj_blocking(approach_q, 6))
